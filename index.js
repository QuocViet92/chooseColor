...
document.addEventListener('click', function (e) {
    if (e.target.dataset.hex) {
        navigator.clipboard
            ...
            .then(function () {
                document.getElementById(e.target.dataset.hex).style.display = 'block';
                setTimeout(() => {
                    document.getElementById(e.target.dataset.hex).style.display = 'none';
                }, 500);
            })
